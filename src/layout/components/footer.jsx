import { ArrowSquareRight } from "@phosphor-icons/react";
 ...
 export const Footer = () => {
    return (
        <footer className="text-center pt-20 border-t-[1px] mt-20">
            ...
            <label className="flex justify-center items-start gap-3">
                <input className="mb-6 border-b-[1px] border-black outline-none placeholder:text-center" type="text" placeholder="Katyamry"/>
            ...
            <div className="border-t-[1px] p-5 container flex justify-between">
